...
Execute the following `create table` commands to create the tables in HAWQ. You can also execute the script [create_pxf_hbase_tables.sql](https://github.com/PivotalHD/pivotal-samples/tree/master/hawq/pxf_hbase_tables/create_pxf_hbase_tables)
...
7. Create table `retail_demo.customers_dim_hbase`
...
<ol>
	...
	<pre class="terminal">hadoop jar /usr/lib/gphd/hbase/hbase.jar importtsv -libjars /usr/lib/gphd/hbase/lib/guava-11.0.2.jar \
...
-Dimporttsv.columns=HBASE_ROW_KEY,cf1:customer_id,cf1:valid_from_timestamp,cf1:valid_to_timestamp,cf1:house_number,cf1:street_name,cf1:appt_suite_no,cf1:city,cf1:state_code,cf1:zip_code,cf1:zip_plus_four,cf1:country,cf1:phone_number customer_addresses_dim /retail_demo/customer_addresses_dim
        ...
        <li>
       <p>Import Data into `customer_addresses_dim` HBase table</p>
	<pre class="terminal">hadoop jar /usr/lib/gphd/hbase/hbase.jar importtsv -libjars /usr/lib/gphd/hbase/lib/guava-11.0.2.jar -Dimporttsv.columns=HBASE_ROW_KEY,cf1:first_name,cf1:last_name,cf1:gender customers_dim /retail_demo/customers_dim
	</pre>
	</li>
...
```bash
demo=# select "cf1:billing_address_postal_code", 
